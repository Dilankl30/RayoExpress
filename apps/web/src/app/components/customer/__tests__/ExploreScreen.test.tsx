...
describe('ExploreScreen', () => {
  ...
  it('renders the explore screen shell', () => {
    renderScreen();
    expect(screen.getByText('Explora tiendas cercanas')).toBeTruthy();
    expect(screen.getByPlaceholderText('Buscar tiendas o categorías')).toBeTruthy();
  });
});
