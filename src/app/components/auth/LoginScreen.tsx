    ...
    >
      ...
      >
        ...
        <div className="flex gap-3 mb-5">
          <button className="flex-1 flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-3 hover:bg-gray-50 transition-colors text-sm text-gray-600">
        ...
        {tab === 'email' ? (
          <div className="space-y-3">
            ...
            <div className="flex justify-end">
              <button className="text-sm" style={{ color: '#6D28D9' }}>
