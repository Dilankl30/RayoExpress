    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-100 px-4 py-4 flex items-center gap-3">
          ...
          <h1 className="font-bold text-gray-900">Solicitud de Tienda</h1>
        </div>
        <div className="max-w-lg mx-auto px-4 py-12 text-center">
          {existing.status === 'pending' && (
            <div className="bg-amber-50 rounded-2xl p-8 border border-amber-200">
              ...
              <p className="text-sm text-gray-600">Tu solicitud está siendo evaluada. Te notificaremos cuando haya una respuesta.</p>
            </div>
          )}
          {existing.status === 'approved' && (
            <div className="bg-green-50 rounded-2xl p-8 border border-green-200">
              <CheckCircle size={48} className="text-green-500 mx-auto mb-4" />
              <h2 className="text-lg font-bold text-gray-900 mb-2">¡Solicitud aprobada!</h2>
              <p className="text-sm text-gray-600">Ya puedes gestionar tu tienda desde el panel de tienda.</p>
            </div>
          )}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-100 px-4 py-4 flex items-center gap-3">
        ...
        <h1 className="font-bold text-gray-900">Registrar Tienda</h1>
      </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        <div className="bg-purple-50 rounded-2xl p-5 border border-purple-100 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-900">¿Tienes un negocio?</p>
            <p className="text-xs text-gray-600">Completa el formulario y un administrador revisará tu solicitud para activar tu tienda en RayoExpress.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 space-y-4 shadow-sm border border-gray-100">
          <div>
            <p className="text-xs text-gray-400 mb-1 font-medium">Nombre de la tienda</p>
            <input
              type="text"
              value={storeName}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-gray-50 rounded-xl px-4 py-3 text-gray-900 outline-none text-sm resize-none"
            />
          </div>

          <div>
            <p className="text-xs text-gray-400 mb-1 font-medium">Dirección</p>
            <input
              type="text"
              value={address}
          ...
          <div>
            <p className="text-xs text-gray-400 mb-1 font-medium">Teléfono de contacto</p>
            <input
              type="tel"
              value={phone}
