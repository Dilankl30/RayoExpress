...
const mockDriverApps: PendingDriverApp[] = [
  { id: 'mock-d-1', user_id: 'mock-u-3', full_name: 'Luis Martínez', phone: '0999999993', vehicle_type: 'moto', vehicle_plate: 'ABC-123', status: 'pending', rejection_reason: null, created_at: new Date(Date.now() - 1800000).toISOString(), applicant: { full_name: 'Luis Martínez', email: 'luis@mail.com' } },
  { id: 'mock-d-2', user_id: 'mock-u-4', full_name: 'Ana Rodríguez', phone: '0999999994', vehicle_type: 'bicicleta', vehicle_plate: '', status: 'pending', rejection_reason: null, created_at: new Date(Date.now() - 5400000).toISOString(), applicant: { full_name: 'Ana Rodríguez', email: 'ana@mail.com' } },
];
